...
Real-Time Track & Trace: A professional, interactive delivery timeline with live status updates.

Enterprise Dashboard: A 50/50 split layout designed specifically for 3PL (Third-Party Logistics) providers.

🛠️ Tech Stack
Framework: Next.js (App Router)

Styling: Tailwind CSS (Deep Slate Navy & Saffron Orange)

Developer: Abhishek Rege
